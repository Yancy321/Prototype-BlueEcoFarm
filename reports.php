...
<h1 class="page-title">PDF Stock Movement Report</h1>

<div class="card card-narrow">
    <h2>Generate Report</h2>
    <p class="text-muted-sm">Select a date range and optional filters, then click "Generate Report" to download the PDF.</p>

    <form id="reportForm">
        <div class="form-grid-2">
            <div class="form-group">
                <label>Date From <span class="required-star">*</span></label>
                <input type="date" id="dateFrom" name="date_from" required value="<?= date('Y-m-01') ?>">
            </div>
            <div class="form-group">
                <label>Date To <span class="required-star">*</span></label>
